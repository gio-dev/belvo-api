 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class IncomeEyod implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IncomeEyod';
     ...
     *
     * @param string $account_holder_id The unique `account_holder_id` the account belongs to, as you provided in the Income Verification request.
     *
     * @return $this
     */
