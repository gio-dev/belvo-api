...
/**
 * TransactionCreditCardData Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TransactionCreditCardData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Transaction_credit_card_data';
    ...
    const BILL_STATUS_CLOSED = 'CLOSED';
    const BILL_STATUS_OPEN = 'OPEN';
    const BILL_STATUS_FUTURE = 'FUTURE';
    const BILL_STATUS_NULL = 'null';
     ...
     * @return string[]
     */
    public function getBillStatusAllowableValues()
    {
        return [
            self::BILL_STATUS_PAID,
            self::BILL_STATUS_CLOSED,
            self::BILL_STATUS_OPEN,
            self::BILL_STATUS_FUTURE,
            self::BILL_STATUS_NULL,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getBillStatusAllowableValues();
        if (!is_null($this->container['bill_status']) && !in_array($this->container['bill_status'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'bill_status', must be one of '%s'",
     ...
     * Sets bill_name
     *
     * @param string $bill_name The title of the monthly credit card bill the transaction belongs to. The format of the returned value is institution specific, however, some common examples are:  - diciembre-2021 - dec-2021 - dec-21
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getBillStatusAllowableValues();
        if (!is_null($bill_status) && !in_array($bill_status, $allowedValues, true)) {
     ...
     * Sets bill_amount
     *
     * @param float $bill_amount The aggregate bill amount, as of `collected_at`.
     *
     * @return $this
     */
     ...
     *
     * @param string $previous_bill_total The total amount of the previous month's bill, if available.
     *
     * @return $this
     */
