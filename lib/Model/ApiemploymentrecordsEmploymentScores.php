...
/**
 * ApiemploymentrecordsEmploymentScores Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ApiemploymentrecordsEmploymentScores implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'apiemploymentrecords_employment_scores';
     ...
     * Sets period
     *
     * @param int $period The number of months (in the future) that the score is calculated for.  For example, a period of `6` indicates that the score is calculated for the next `6` months.  > **Note**: At present Belvo calculates the score for 3, 6, and 12 months.
     *
     * @return $this
     */
     ...
     * Sets version
     *
     * @param string $version The version of our employment score model used to perform the calculation.
     *
     * @return $this
     */
