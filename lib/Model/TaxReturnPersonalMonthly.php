...
/**
 * TaxReturnPersonalMonthly Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TaxReturnPersonalMonthly implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Tax Return Personal Monthly';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['isr'] = isset($data['isr']) ? $data['isr'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['isr'] === null) {
            $invalidProperties[] = "'isr' can't be null";
        }
        if ($this->container['iva'] === null) {
            $invalidProperties[] = "'iva' can't be null";
        }
    ...
    {
        return $this->container['isr'];
    }

    /**
     * Sets isr
     *
     * @param object $isr Information used to calculate the monthly provisional payments of the income tax.
     *
     * @return $this
     */
    public function setIsr($isr)
    {
        $this->container['isr'] = $isr;
     ...
     * Sets iva
     *
     * @param object $iva Information used to calculate the monthly provisional payments of the VAT tax.
     *
     * @return $this
     */
