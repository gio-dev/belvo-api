<?php
/**
 * AccountsOFDABrazilCreditDataCards
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * AccountsOFDABrazilCreditDataCards Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AccountsOFDABrazilCreditDataCards implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Accounts OFDA Brazil_credit_data_cards';
     ...
     * Sets is_multiple
     *
     * @param bool $is_multiple Boolean to indicate if this account has multiple credit cards.  > **Non-nullable:** A value must be returned by Brazil's open finance network.
     *
     * @return $this
     */
