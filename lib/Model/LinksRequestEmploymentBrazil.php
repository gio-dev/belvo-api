...
/**
 * LinksRequestEmploymentBrazil Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LinksRequestEmploymentBrazil implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LinksRequestEmploymentBrazil';
     ...
     * Sets institution
     *
     * @param string $institution The Belvo name for the institution. For employment institutions in Brazil, you can select the following institutions:  - `inss_br_employment`
     *
     * @return $this
     */
     ...
     * Sets username
     *
     * @param string $username The user's CPF (ID) used to log in to the institution.
     *
     * @return $this
     */
