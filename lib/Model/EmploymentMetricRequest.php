...
/**
 * EmploymentMetricRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EmploymentMetricRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EmploymentMetricRequest';
     ...
     * Sets link
     *
     * @param string $link The `link.id` you want to retrieve employment metrics for.
     *
     * @return $this
     */
