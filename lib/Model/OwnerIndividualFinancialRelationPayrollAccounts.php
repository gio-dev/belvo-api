<?php
/**
 * OwnerIndividualFinancialRelationPayrollAccounts
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * OwnerIndividualFinancialRelationPayrollAccounts Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OwnerIndividualFinancialRelationPayrollAccounts implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OwnerIndividualFinancialRelation_payroll_accounts';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['account_opening_date'] = isset($data['account_opening_date']) ? $data['account_opening_date'] : null;
    }
     ...
     *
     * @param \DateTime $account_opening_date The date that the salary bank account was opened, in `YYYY-MM-DD` format.
     *
     * @return $this
     */
