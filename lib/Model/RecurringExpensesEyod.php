...
/**
 * RecurringExpensesEyod Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RecurringExpensesEyod implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RecurringExpensesEyod';
     ...
     *
     * @param string $account_holder_id The unique ID you provided for the account holder.
     *
     * @return $this
     */
     ...
     * Sets account_id
     *
     * @param string $account_id The unique ID you provided for the account where the transaction occurred.
     *
     * @return $this
     */
