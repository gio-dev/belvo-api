...
/**
 * LinksRequestFiscalMexico Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LinksRequestFiscalMexico implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LinksRequestFiscalMexico';
     ...
     * Sets institution
     *
     * @param string $institution The Belvo name for the institution. For fiscal institutions in Mexico, you can select the following institutions:  - `sat_mx_fiscal` - `tatooine_mx_fiscal` (Sandbox institution)
     *
     * @return $this
     */
     ...
     * Sets username
     *
     * @param string $username The user's RFC (tax ID) used to log in to the institution.
     *
     * @return $this
     */
     ...
     *
     * @param string[] $fetch_resources An array of resources that you would like to receive a historical update for.  For fiscal institutions, you can select the following resources:   - `FINANCIAL_STATEMENTS`   - `INVOICES`   - `TAX_COMPLIANCE_STATUS`   - `TAX_RETENTIONS`   - `TAX_RETURNS`   - `TAX_STATUS`
     *
     * @return $this
     */
