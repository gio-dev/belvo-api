...
/**
 * OwnerBusinessProducts Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OwnerBusinessProducts implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OwnerBusinessProducts';
     ...
     * Sets type
     *
     * @param string $type The additional products the business has at the institution. We return one of the following values:    - `SAVINGS_ACCOUNT`   - `CHECKING_ACCOUNT`   - `null`
     *
     * @return $this
     */
     ...
     * Sets subtype
     *
     * @param string $subtype The subtype of the product that the business has at the institution.  > **Non-nullable:** A value must be returned by Brazil's open finance network if the `products` field is available.
     *
     * @return $this
     */
     ...
     * Sets number
     *
     * @param string $number The account number of the product.  > **Non-nullable:** A value must be returned by Brazil's open finance network if the `products` field is available.
     *
     * @return $this
     */
