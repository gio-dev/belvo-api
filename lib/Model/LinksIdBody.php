 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LinksIdBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'links_id_body';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['username_type'] = isset($data['username_type']) ? $data['username_type'] : null;
    }
     ...
     * Sets password
     *
     * @param string $password The end-user's password used to log in to the institution.
     *
     * @return $this
     */
     ...
     * Sets token
     *
     * @param string $token The MFA token required by the bank to log in.
     *
     * @return $this
     */
