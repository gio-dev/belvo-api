...
/**
 * ApiIncomesBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ApiIncomesBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'api_incomes_body';
     ...
     * Sets date_from
     *
     * @param string $date_from The date from which you want to start getting incomes for, in `YYYY-MM-DD` format, within the last 365 days. When you use this parameter, you must also send `date_to`.   ⚠️ You must have at least 90 days between `date_from` and `date_to`.   ⚠️ The value of `date_from` cannot be greater than `date_to`.
     *
     * @return $this
     */
     ...
     * Sets date_to
     *
     * @param string $date_to The date you want to stop getting incomes for, in `YYYY-MM-DD` format, within the last 365 days. When you use this parameter, you must also send `date_from`.   ⚠️ You must have at least 90 days between `date_from` and `date_to`.   ⚠️ The value of `date_to` cannot be greater than today's date (in other words, no future dates).
     *
     * @return $this
     */
