<?php
/**
 * TransactionStandardMultiRegion
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * TransactionStandardMultiRegion Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TransactionStandardMultiRegion implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Transaction Standard MultiRegion';
    ...
    protected static $swaggerTypes = [
        ...
        'type' => 'string',
        'status' => 'string',
        'credit_card_data' => '\Swagger\Client\Model\TransactionCreditCardData'
    ];
     ...
     *
     * @param string $internal_identification The institution's internal identification for the transaction.
     *
     * @return $this
     */
     ...
     *
     * @param string $accounting_date The date when the transaction was processed and accounted for by the institution, in `YYYY-MM-DD` format.
     *
     * @return $this
     */
     ...
     * Sets amount
     *
     * @param float $amount The transaction amount. ℹ️ The amount displayed is always positive as we indicate the direction of the transaction in the `type` parameter.
     *
     * @return $this
     */
     ...
     * Sets balance
     *
     * @param float $balance The balance at the end of the transaction.
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string $description The description of transaction provided by the institution. Usually this is the text that the end user sees in the online platform.
     *
     * @return $this
     */
     ...
     * Sets observations
     *
     * @param string $observations Additional observations provided by the institution on the transaction.
     *
     * @return $this
     */
     ...
     * Sets reference
     *
     * @param string $reference The reference number of the transaction, provided by the bank.
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\TransactionCreditCardData
     */
     ...
     *
     * @param \Swagger\Client\Model\TransactionCreditCardData $credit_card_data credit_card_data
     *
     * @return $this
     */
