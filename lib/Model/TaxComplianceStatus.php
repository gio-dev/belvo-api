...
/**
 * TaxComplianceStatus Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TaxComplianceStatus implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TaxComplianceStatus';
    ...
    const OUTCOME_NO_OBLIGATIONS = 'NO_OBLIGATIONS';
     ...
     *
     * @param string $internal_identification The institution’s internal identification number for the document.
     *
     * @return $this
     */
     ...
     * Sets pdf
     *
     * @param string $pdf Tax compliance status PDF as a binary.
     *
     * @return $this
     */
     ...
     * Sets rfc
     *
     * @param string $rfc The account holder's RFC (Registro Federal de Contribuyentes) number.
     *
     * @return $this
     */
     ...
     * Sets outcome
     *
     * @param string $outcome Indicates whether the taxpayer is complying to all their tax obligations (`POSITIVE`), if they are not (`NEGATIVE`), or have none to comply to (`NO_OBLIGATIONS`).
     *
     * @return $this
     */
