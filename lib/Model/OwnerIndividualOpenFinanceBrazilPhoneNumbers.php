<?php
/**
 * OwnerIndividualOpenFinanceBrazilPhoneNumbers
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * OwnerIndividualOpenFinanceBrazilPhoneNumbers Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OwnerIndividualOpenFinanceBrazilPhoneNumbers implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OwnerIndividualOpenFinanceBrazil_phone_numbers';
     ...
     * Sets is_main
     *
     * @param bool $is_main Boolean to indicate if this is the user's main phone number.  > **Non-nullable:** A value must be returned by Brazil's open finance network.
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type The type of phone number. We return one of the following values:    - `LANDLINE`   - `MOBILE`   - `OTHER`   - `null`
     *
     * @return $this
     */
     ...
     *
     * @param string $additional_info Additional information about the phone number.
     *
     * @return $this
     */
     ...
     * Sets number
     *
     * @param string $number The phone number (not including the country, area, or extension codes).  > **Non-nullable:** A value must be returned by Brazil's open finance network.
     *
     * @return $this
     */
     ...
     * Sets country_code
     *
     * @param string $country_code The country dialling code. For example: `351` (no `+`).
     *
     * @return $this
     */
     ...
     * Sets area_code
     *
     * @param string $area_code The area dialling code.
     *
     * @return $this
     */
