<?php
/**
 * OwnerBusinessOpenFinanceBrazilFinancialRelation
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * OwnerBusinessOpenFinanceBrazilFinancialRelation Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OwnerBusinessOpenFinanceBrazilFinancialRelation implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OwnerBusinessOpenFinanceBrazil_financial_relation';
    ...
    protected static $swaggerTypes = [
        ...
        'products' => '\Swagger\Client\Model\OwnerBusinessFinancialRelationProducts[]'
    ];
     ...
     * Sets start_date
     *
     * @param \DateTime $start_date The ISO-8601 timestamp when the financial relationship between the business and the institution started.  > **Non-nullable:** A value must be returned by Brazil's open finance network.
     *
     * @return $this
     */
     ...
     *
     * @param string[] $product_services A list of products that the business has with the institution.  > **Non-nullable:** A value must be returned by Brazil's open finance network.
     *
     * @return $this
     */
     ...
     * Gets products
     *
     * @return \Swagger\Client\Model\OwnerBusinessFinancialRelationProducts[]
     */
     ...
     * Sets products
     *
     * @param \Swagger\Client\Model\OwnerBusinessFinancialRelationProducts[] $products Details regarding any additional products that the business has with the institution.
     *
     * @return $this
     */
