<?php
/**
 * ApirecurringexpensesTransactions
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * ApirecurringexpensesTransactions Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ApirecurringexpensesTransactions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'apirecurringexpenses_transactions';
     ...
     * Sets description
     *
     * @param string $description The description of the transaction provided by the institution. Usually, this is the text that the end user would see in the bank statement. The description can be an empty string.  > **Note:** For EYOD Risk Insights, the description is the one that you provided in the initial request.
     *
     * @return $this
     */
