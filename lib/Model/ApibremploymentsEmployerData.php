...
/**
 * ApibremploymentsEmployerData Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ApibremploymentsEmployerData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'apibremployments_employer_data';
     ...
     * Sets code
     *
     * @param string $code The institution's unique code for the employer.
     *
     * @return $this
     */
     ...
     *
     * @param string $economic_activity The main economic activity the employer is involved in. For Brazil, this is the *Classificação Nacional de Atividades Econômicas* (CNAE) code.
     *
     * @return $this
     */
