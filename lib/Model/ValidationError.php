...
class ValidationError implements ModelInterface, ArrayAccess
{
     ...
     * Sets message
     *
     * @param string $message A short description of the error.    For validation errors, the description can be (among others):      - `This field is required.`   - `Object with name=narnia does not exist.`   - `This field may not be null.`   - `This field may not be blank.`
     *
     * @return $this
     */
     ...
     * Sets field
     *
     * @param string $field Name of the field where the error was encountered.
     *
     * @return $this
     */
