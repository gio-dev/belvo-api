<?php
/**
 * OwnerIndividualOpenFinanceBrazilAdditionalDocuments
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * OwnerIndividualOpenFinanceBrazilAdditionalDocuments Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OwnerIndividualOpenFinanceBrazilAdditionalDocuments implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OwnerIndividualOpenFinanceBrazil_additional_documents';
     ...
     * Sets check_digit
     *
     * @param string $check_digit The check digit of the ID document.  > **Non-nullable:** A value must be returned by Brazil's open finance network.
     *
     * @return $this
     */
