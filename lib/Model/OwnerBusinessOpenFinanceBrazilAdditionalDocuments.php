...
/**
 * OwnerBusinessOpenFinanceBrazilAdditionalDocuments Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OwnerBusinessOpenFinanceBrazilAdditionalDocuments implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OwnerBusinessOpenFinanceBrazil_additional_documents';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['type_additional_info'] = isset($data['type_additional_info']) ? $data['type_additional_info'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['type_additional_info'] === null) {
            $invalidProperties[] = "'type_additional_info' can't be null";
        }
     ...
     *
     * @param string $type_additional_info Additional information regarding the document type.  > Note: For Business ID documents, this field must return a value from Brazil's open finance network.
     *
     * @return $this
     */
     ...
     * Sets check_digit
     *
     * @param string $check_digit The check digit of the ID document.  > **Note**: This field is not applicable for Business ID documents and will return `null`.
     *
     * @return $this
     */
     ...
     * Sets issue_date
     *
     * @param \DateTime $issue_date The date the the ID document was issued, in `YYYY-MM-DD` format.  > **Note**: This field is not applicable for Business ID documents and will return `null`.
     *
     * @return $this
     */
     ...
     *
     * @param string $country_of_issuance The three-letter country code that issued the document (in ISO-3166 Alpha 3 format).  > **Non-nullable:** A value must be returned by Brazil's open finance network.
     *
     * @return $this
     */
     ...
     *
     * @param string $additional_info Additional information about the ID document.  > **Note**: This field is not applicable for Business ID documents and will return `null`.
     *
     * @return $this
     */
