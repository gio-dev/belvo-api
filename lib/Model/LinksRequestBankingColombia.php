...
/**
 * LinksRequestBankingColombia Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LinksRequestBankingColombia implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LinksRequestBankingColombia';
     ...
     * Sets institution
     *
     * @param string $institution The Belvo name for the institution. For banking institutions in Colombia, you can select the following institutions:  - `bancolombia_co_retail` - `erebor_co_retail` (Sandbox institution)
     *
     * @return $this
     */
     ...
     * Sets username
     *
     * @param string $username The user's ID used to log in to the institution.
     *
     * @return $this
     */
     ...
     * Sets password
     *
     * @param string $password The user's password used to log in to the institution.
     *
     * @return $this
     */
     ...
     *
     * @param string[] $fetch_resources An array of resources that you would like to receive a historical update for.  For banking institutions in Colombia, you can select the following resources:   - `ACCOUNTS`   - `OWNERS`   - `TRANSACTIONS`   - `INCOMES`   - `RECURRING_EXPENSES`   - `RISK_INSIGHTS`
     *
     * @return $this
     */
