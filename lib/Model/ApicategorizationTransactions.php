...
/**
 * ApicategorizationTransactions Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ApicategorizationTransactions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'apicategorization_transactions';
     ...
     *
     * @param string $account_holder_id Your unique ID for the account holder.
     *
     * @return $this
     */
