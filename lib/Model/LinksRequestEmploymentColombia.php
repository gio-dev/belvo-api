...
/**
 * LinksRequestEmploymentColombia Class Doc Comment
 *
 * @category Class
 * @description The request body to create a link for employment institutions in Colombia.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LinksRequestEmploymentColombia implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LinksRequestEmploymentColombia';
     ...
     * Sets institution
     *
     * @param string $institution The Belvo name for the institution. For employment institutions in Colombia, you can select the following institutions:  - `pila_co_employment`
     *
     * @return $this
     */
     ...
     * Sets username
     *
     * @param string $username The user's *Cédula de Ciudadanía* (ID) used to log in to the institution.
     *
     * @return $this
     */
     ...
     *
     * @param string[] $fetch_resources An array of resources that you would like to receive a historical update for.  For employment institutions, you can select the following resources:   - `OWNERS`   - `EMPLOYMENTS`
     *
     * @return $this
     */
