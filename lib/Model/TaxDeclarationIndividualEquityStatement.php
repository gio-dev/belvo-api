...
/**
 * TaxDeclarationIndividualEquityStatement Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TaxDeclarationIndividualEquityStatement implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TaxDeclarationIndividual_equity_statement';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['total_debts'] = isset($data['total_debts']) ? $data['total_debts'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['total_debts'] === null) {
            $invalidProperties[] = "'total_debts' can't be null";
        }
     ...
     *
     * @param float $total_gross_equity The total gross equity of the tax payer.
     *
     * @return $this
     */
    ...
    {
        return $this->container['total_debts'];
    }

    /**
     * Sets total_debts
     *
     * @param float $total_debts The total debts of the tax_payer
     *
     * @return $this
     */
    public function setTotalDebts($total_debts)
    {
        $this->container['total_debts'] = $total_debts;
     ...
     *
     * @param float $total_net_equity The total net equity value of the taxpayer.
     *
     * @return $this
     */
