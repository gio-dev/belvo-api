<?php
/**
 * TransactionOpenFinanceBrazilCounterparty
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * TransactionOpenFinanceBrazilCounterparty Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TransactionOpenFinanceBrazilCounterparty implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TransactionOpenFinanceBrazil_counterparty';
     ...
     * Sets type
     *
     * @param string $type The transaction counterparty type. We return one of the following values:    - `INDIVIDUAL`   - `COMPANY`   - `null`
     *
     * @return $this
     */
     ...
     *
     * @param string $document_number The document number of the representative.  **Note**:   For Brazil:   - When the `type` is `INDIVIDUAL`, this is the CPF number.   - When the `type` is `COMPANY`, this is the CNPJ number.
     *
     * @return $this
     */
     ...
     * Sets clearing_code
     *
     * @param string $clearing_code The banking clearing code.
     *
     * @return $this
     */
     ...
     * Sets agency
     *
     * @param string $agency The branch code where the account was opened.
     *
     * @return $this
     */
     ...
     * Sets check_digit
     *
     * @param string $check_digit The check digit of the account number, if applicable.
     *
     * @return $this
     */
     ...
     * Sets number
     *
     * @param string $number The account number of the product.
     *
     * @return $this
     */
